...
export default function TermsPage() {
  return (
    <div className={styles.shell}>
      <Header />
      <main>
        <section className={`${styles.hero} ${styles.heroCompact}`}><span className={styles.heroKicker}>Information</span><h1 className={styles.displayTitle}>Terms</h1><p className={styles.heroCopy}>Order, product, and custom-work terms for Rana Velvet customers.</p></section>
