...
export default function PrivacyPage() {
  return (
    <div className={styles.shell}>
      <Header />
      <main>
        <section className={`${styles.hero} ${styles.heroCompact}`}><span className={styles.heroKicker}>Information</span><h1 className={styles.displayTitle}>Privacy</h1><p className={styles.heroCopy}>How Rana Velvet uses the details shared through the website.</p></section>
